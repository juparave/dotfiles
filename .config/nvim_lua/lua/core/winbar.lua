-- Not working, part of a bigger config structure, here for reference only
-- ref: https://alpha2phi.medium.com/neovim-for-beginners-window-bar-e7b4435fc7e9
-- ref: https://github.com/alpha2phi/neovim-for-beginner/blob/42-winbar/lua/config/winbar.lua
local M = {}
